        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img
              src={headshot}
              alt="Matt headshot"
              className="w-80 h-80 md:w-96 md:h-96 rounded-2xl object-cover shadow-lg"
            />
          </motion.div>
          <motion.div
          ...
          >
            ...
            <div className="space-y-5 text-muted-foreground font-body font-light leading-relaxed">
              <p>
                Matt is a student at Utah Valley University, studying interaction design. He loves designing, researching, and creating anything related to websites and user experience! He enjoys photography, gaming, and reading, and he is passionate about what he does.
              </p>
