...
const CaseStudyBridge = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <motion.section {...fade} className="py-12">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 items-start">
            ...
            <img src={bridgePaper} alt="Paper prototype" className="rounded-lg shadow-md w-36 md:w-44" loading="lazy" />
          </div>
        </div>
      </motion.section>
      ...
      <motion.section {...fade} className="py-4">
        <div className="max-w-3xl mx-auto px-6 md:px-12 flex justify-center gap-4">
          <img src={bridgeDigital1} alt="Digital prototype — lobby view" className="rounded-lg shadow-md w-48 md:w-56" loading="lazy" />
          <img src={bridgeDigital2} alt="Digital prototype — role assignment" className="rounded-lg shadow-md w-48 md:w-56" loading="lazy" />
        </div>
      </motion.section>
